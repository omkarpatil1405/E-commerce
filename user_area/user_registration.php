    ...
    <div class="row d-flex align-items-center justify-content-center">
        <div class="lg-12 col-xl-6">
         ...
         <div class="form-outline mb-4">
                ...
                <input type="text" id="user_username" class="form-control" placeholder="Enter your username" required="required" autocomplete="off" name="user_username">
            </div>
           <!--email--> 
            <div class="form-outline mb-4">
            ...
            <div class="form-outline mb-4">
                ...
                <input type="password" id="conf_user_password" class="form-control" placeholder="Enter Confirm password" required="required" name="conf_user_password"> 
           </div> 
                <!--user address--> 
           <div class="form-outline mb-4">
            ...
            <!--user mobile--> 
           <div class="form-outline mb-4">
                <lable for="user_contact" class="form-lable">Mobile no</lable>
